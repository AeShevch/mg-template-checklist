...
- [ ] Корзина:
	...
	- [ ] [Всплывающий попап корзины](#попап-и-модалка-корзины) при наведении/клику на ссылку «В корзину»	
...
- [ ] Группы товаров:
    ...
    - [ ] Новинки (Товары, отмеченные лэблом «Новинка» в админке)	    
        - [ ] Каждая группа содержит:
            ...
            - [ ] [Миникарточки](#миникарточка-товаров) товаров (Чеклист для миникарточки описан ниже)
...
- [ ] Товары категории
    ...
    - [ ] Применённые фильтры
    - [ ] [Миникарточки](#миникарточка-товаров) товара
...
- [ ] Кнопка [«Добавить в корзину»](#кнопка-купить)         
...
### Страница корзины
- [ ] Таблица товаров, каждый ряд товара содержит: 
   - [ ] картинку
   - [ ] название
   - [ ] ссылку на товар
...
- [ ] Общая сумма корзины
- [ ] Возможность ввести промокод (Плагины «Скидочные промокоды» и «Расширенные промокоды»)
- [ ] Блок «С этими товарами покупают»
- [ ] Ссылка на переход на страницу оформления заказа

### Страница офоромления заказа
- [ ] [Корзина](#страница-корзины)
- [ ] Возможность ввести промокод (Плагины «Скидочные промокоды» и «Расширенные промокоды»)
- [ ] Форма оформления:
    - [ ] Статичная, для редакции ниже Гипермаркет
    - [ ] Настраиваемая через админку
- [ ] Выбор складов
- [ ] Пересчёт цены при изменении корзины, выборе доставки или оплаты с наценкой
...
- [ ] Список заказов
    ...
    - [ ] Возможность сменить способ оплаты
    - [ ] Стоимость заказа
    - [ ] Стоимость заказа с доставкой
    - [ ] Способ оплаты
    - [ ] Ссылка на страницу оплаты
- [ ] Форма данных о пользователе с возможностью добавления дополнительных полей из админки
- [ ] Форма смены пароль
...
### Страница сравнения     
- [ ] Слайдер товаров с характеристиками
- [ ] Возможность выбрать категорию сравниваемых товаров, если это разрешено в админке
- [ ] Возможность удалить товар и сравнения
- [ ] Возможность добавить товарв корзину
